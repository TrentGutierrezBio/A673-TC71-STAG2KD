...
datatable(A673_ordered_gse_df, class = 'cell-border stripe', 
          caption = "Table 5: GSEA enrichment results for A673 STAG2KO significant DEGs")
```
...
datatable(TC71_ordered_gse_df, class = 'cell-border stripe', 
          caption = "Table 6: GSEA enrichment results for TC71 STAG2KO significant DEGs")
```
...
datatable(SA2KO_ordered_gse_df, class = 'cell-border stripe', 
          caption = "Table 7: GSEA enrichment results for all STAG2KO samples significant DEGs")
```
